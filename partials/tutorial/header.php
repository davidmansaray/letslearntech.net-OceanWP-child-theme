...
<header class="entry-header clr">
	<<?php echo esc_attr( $heading ); ?> class="tutorial-title entry-title"<?php oceanwp_schema_markup( 'headline' ); ?>><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></<?php echo esc_attr( $heading ); ?>><!-- .single-post-title -->
</header><!-- .entry-header -->
